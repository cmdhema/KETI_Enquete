...
public abstract class PopupMenuCompat
{
	...
	/**
	 * @return The {@link android.view.Menu} associated with this popup. Populate the returned Menu with items before calling {@link #show()}.
	 * @see #show()
	 * @see #getMenuInflater()
	 */
	...
	/**
	 * @return A {@link android.view.MenuInflater} that can be used to inflate menu items from XML into the menu returned by {@link #getMenu()}.
	 * @see #getMenu()
	 */
